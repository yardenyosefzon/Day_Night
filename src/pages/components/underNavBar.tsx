...
function UnderNavBar() {
  return (
    <div className='flex justify-center fixed bottom-0 w-full'>
      ...
      <IsLoggedIn actionA={<Link href={'/createEvents'} className='py-4 w-1/6 bg-slate-400 justify-center flex border-2 border-black border-l-0'>צור אירוע</Link>} actionB={<Link href={`/logInTo/logInToCreateEvents?callBackUrl=/`} className='py-4 w-1/6 bg-slate-400 justify-center flex border-2 border-black border-l-0'>צור אירוע</Link>}/>
